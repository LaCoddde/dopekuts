...
      //   .from('gallery_items')
      //   .insert([{ category: formData.category, image: formData.image }]);
...
      // const { error } = await supabase
      //   .from('gallery_items')
      //   .update({ category: formData.category, image: formData.image })
...
    // setFormData({ category: item.category, image: item.image });
    setCategory(item.category);
    setImageFile(null);
    setImagePreview(item.image); // Show the existing image URL
...
            <DialogDescription>
              Add a new item to your gallery. Enter the category and upload an
              image.
            </DialogDescription>
          </DialogHeader>
...
            <DialogDescription>
              Update the category. You can optionally upload a new image to
              replace the old one.
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-4 py-4">
